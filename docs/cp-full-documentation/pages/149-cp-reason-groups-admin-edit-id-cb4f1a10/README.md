...
[Home](../../index.md) / [Reason Groups](../148-cp-reason-groups-admin-2d5ac2ad/README.md) / Edit Reason Group

URL: [https://sohohome.com/cp/reason-groups-admin/edit/:id](https://sohohome.com/cp/reason-groups-admin/edit/:id)

Use this screen when you need to check or change an existing reason group.
...
![Identifier](images/field-002-identifier.png)
