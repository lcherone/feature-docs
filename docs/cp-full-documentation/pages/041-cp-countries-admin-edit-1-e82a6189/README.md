...
[Home](../../index.md) / Edit Country

URL: [https://sohohome.com/cp/countries-admin/edit/1](https://sohohome.com/cp/countries-admin/edit/1)

Add the fields

![Countries overview](images/page-desktop.png)
...
![Label](images/field-001-label.png)
...
![Status optional](images/field-002-status-optional.png)
...
![Locale](images/field-004-locale.png)
...
![Add as Alternate Sitemap URL?](images/field-005-add-as-alternate-sitemap-url.png)

*Add as Alternate Sitemap URL? setting*

Turn this on when add as alternate sitemap URL? should apply. Leave it off when it should not.

#### Generate Google Feed?

![Generate Google Feed?](images/field-006-generate-google-feed.png)

*Generate Google Feed? setting*
