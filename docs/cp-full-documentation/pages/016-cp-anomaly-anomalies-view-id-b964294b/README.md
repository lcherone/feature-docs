...
[Home](../../index.md) / [Anomalies](../015-cp-anomaly-anomalies-cc7972c6/README.md) / View Anomaly

URL: [https://sohohome.com/cp/anomaly-anomalies/view/:id](https://sohohome.com/cp/anomaly-anomalies/view/:id)

Anomalies list detected anomalies where recorded counts differ from the expected range.

![Anomalies overview](images/page-desktop.png)
