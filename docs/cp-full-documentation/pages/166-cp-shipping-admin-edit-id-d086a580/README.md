...
[Home](../../index.md) / [Shipping Options](../165-cp-shipping-admin-1deed73f/README.md) / Edit Shipping Option

URL: [https://sohohome.com/cp/shipping-admin/edit/:id](https://sohohome.com/cp/shipping-admin/edit/:id)

App-level shipping option admin customisations.

![Shipping Options overview](images/page-desktop.png)
...
![Display Title](images/field-002-display-title.png)
...
![Supplier Dropship Only optional](images/field-003-supplier-dropship-only-optional.png)
...
![Status](images/field-004-status.png)
...
![Service](images/field-008-service.png)
