...
[Home](../../index.md) / Edit Webhook Token

URL: [https://sohohome.com/cp/ais-webhooks-tokens-admin/edit/1](https://sohohome.com/cp/ais-webhooks-tokens-admin/edit/1)
...
![ais.costprice](images/field-005-ais-costprice.png)

*ais.costprice setting*

Turn this on when ais.costprice should apply. Leave it off when it should not.

#### ais.costpricebatch

![ais.costpricebatch](images/field-006-ais-costpricebatch.png)

*ais.costpricebatch setting*

Turn this on when ais.costpricebatch should apply. Leave it off when it should not.

#### ais.pricelist

![ais.pricelist](images/field-007-ais-pricelist.png)

*ais.pricelist setting*

Turn this on when ais.pricelist should apply. Leave it off when it should not.

#### ais.pricelistbatch

![ais.pricelistbatch](images/field-008-ais-pricelistbatch.png)

*ais.pricelistbatch setting*
