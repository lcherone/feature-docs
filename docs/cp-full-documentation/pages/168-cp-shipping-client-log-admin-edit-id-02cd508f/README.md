...
[Home](../../index.md) / [Shipping Client Log](../167-cp-shipping-client-log-admin-340c1a8c/README.md) / Edit Shipping Client Log

URL: [https://sohohome.com/cp/shipping-client-log-admin/edit/:id](https://sohohome.com/cp/shipping-client-log-admin/edit/:id)

Shipping Client Log Entry.

![Shipping Client Log overview](images/page-desktop.png)
