...
[Home](../../index.md) / [Customers](../052-cp-customers-cbb2a4e5/README.md) / Edit Customer

URL: [https://sohohome.com/cp/customers/edit/:id](https://sohohome.com/cp/customers/edit/:id)
...
![Customers overview](images/page-desktop.png)
...
![Email address](images/field-001-email-address.png)
...
![First name](images/field-002-first-name.png)
...
![Last name](images/field-003-last-name.png)
...
![Sensitive value](images/field-004-hidden.png)

*Sensitive value setting*

Use the expected format shown by the placeholder: "[hidden]".

#### Password (optional)

![Password optional](images/field-005-password-optional.png)
...
![Confirm Password optional](images/field-006-confirm-password-optional.png)
