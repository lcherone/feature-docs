...
[Home](../../index.md) / [Supplier Holidays](../197-cp-supplier-holidays-admin-298f7ec1/README.md) / Create Supplier Holiday
...
![Supplier Holidays overview](images/page-desktop.png)

*Supplier Holidays page overview*

## Related Pages

- [Supplier Holidays](../197-cp-supplier-holidays-admin-298f7ec1/README.md): MTO supplier holiday periods tracks closure dates for suppliers (e.g. christmas, TET, CNY) extra days are added to MTO lead times when the production window overlaps the holiday
...
![Title](images/field-001-title.png)
...
![Date From](images/field-002-date-from.png)
...
![Date To](images/field-003-date-to.png)
...
![Buffer Days optional](images/field-004-buffer-days-optional.png)
