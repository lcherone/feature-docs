...
![CP Styleguide overview](images/page-desktop.png)
...
- [CP Styleguide](../234-cp-styleguide-admin-select-multiple-field-25ecafe5/README.md): CP Styleguide shows the details for this CP styleguide.
...
![Search...](images/field-001-search.png)

*Search... setting*

Use the expected format shown by the placeholder: "Search...".

#### Basic autocomplete

![Basic autocomplete](images/field-002-basic-autocomplete.png)

*Basic autocomplete setting*

Use the expected format shown by the placeholder: "This won't acually get any completions...".

#### Select country

![Select country](images/field-003-select-country.png)

*Select country setting*

Use the expected format shown by the placeholder: "Search for a country...".

#### select-autocomplete-example-select

![select-autocomplete-example-select](images/field-004-select-autocomplete-example-select.png)

*select-autocomplete-example-select setting*

Choose the option that matches this select-autocomplete-example-select.

**Options:** United Kingdom, South Georgia and the South Sandwich Islands, Heard Island and McDonald Islands, U.S. Minor Outlying Islands, United States, Saint Vincent and the Grenadines, Ascension Island, Andorra, United Arab Emirates, Afghanistan, Antigua and Barbuda, Anguilla, and 17 more

#### AJAX country

![AJAX country](images/field-005-ajax-country.png)
...
![Country as ISO 2](images/field-006-country-as-iso-2.png)

*Country as ISO 2 setting*

Use the expected format shown by the placeholder: "Search for a country...".

#### example

![example](images/field-007-example.png)
