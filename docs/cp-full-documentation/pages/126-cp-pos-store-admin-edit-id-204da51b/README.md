...
[Home](../../index.md) / [Stores](../125-cp-pos-store-admin-53f57f75/README.md) / Edit Store

URL: [https://sohohome.com/cp/pos-store-admin/edit/:id](https://sohohome.com/cp/pos-store-admin/edit/:id)

Add local bits.

![Stores overview](images/page-desktop.png)
...
1. Scan the fields in the table to find the store you need.
...
![Business Number](images/field-003-business-number.png)
