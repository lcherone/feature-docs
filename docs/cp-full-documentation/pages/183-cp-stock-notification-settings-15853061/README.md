...
![Minimum Stock To Trigger Noifications](images/field-001-minimum-stock-to-trigger-noifications.png)
...
![Notifications Per Product Per Run](images/field-002-notifications-per-product-per-run.png)
