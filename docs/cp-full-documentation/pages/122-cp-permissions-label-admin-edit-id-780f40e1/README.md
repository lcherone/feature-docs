...
[Home](../../index.md) / [Permission Labels](../121-cp-permissions-label-admin-19ecf6a4/README.md) / Edit Permission Label

URL: [https://sohohome.com/cp/permissions-label-admin/edit/:id](https://sohohome.com/cp/permissions-label-admin/edit/:id)

Implement custom template for permissions field

![Permission Labels overview](images/page-desktop.png)
...
![Yes Label optional](images/field-002-yes-label-optional.png)
...
![No Label optional](images/field-003-no-label-optional.png)
...
![Language](images/field-004-language.png)
