...
![Example Admin User](images/field-002-example-admin-user.png)

*Example Admin User setting*

Choose the option that matches this example admin user.

**Options:** olivia.hallam@sohohouse.com, paula.richardson@sohohouse.com, camilla.fox@sohohouse.com, lewis.hamilton@sohohouse.com, milly.mackaywilson@sohohouse.com, anna.maxwell@sohohouse.com, Rhea.Pitts-Brennan@sohohouse.com, charlotte.sears@sohohouse.com, sophie.farrierarmson@sohohouse.com, hannah.mallinson@sohohouse.com, laura.stewart@sohohouse.com, gaby.patterson@sohohouse.com, and 17 more

#### Example Admin User

![Example Admin User](images/field-003-example-admin-user.png)
...
![Example Admin User](images/field-004-example-admin-user.png)

*Example Admin User setting*

Choose the option that matches this example admin user.

**Effect:** An example sub description

**Options:** olivia.hallam@sohohouse.com, paula.richardson@sohohouse.com, camilla.fox@sohohouse.com, lewis.hamilton@sohohouse.com, milly.mackaywilson@sohohouse.com, anna.maxwell@sohohouse.com, Rhea.Pitts-Brennan@sohohouse.com, charlotte.sears@sohohouse.com, sophie.farrierarmson@sohohouse.com, hannah.mallinson@sohohouse.com, laura.stewart@sohohouse.com, gaby.patterson@sohohouse.com, and 17 more

**Notes:** An example sub description

#### Example Admin User

![Example Admin User](images/field-005-example-admin-user.png)

*Example Admin User setting*

Use the expected format shown by the placeholder: "select…".

#### Example Admin User

![Example Admin User](images/field-006-example-admin-user.png)
