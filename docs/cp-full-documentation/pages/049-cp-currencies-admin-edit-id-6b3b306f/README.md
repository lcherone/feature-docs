...
[Home](../../index.md) / [Currencies](../048-cp-currencies-admin-f7b395f4/README.md) / Edit Currency

URL: [https://sohohome.com/cp/currencies-admin/edit/:id](https://sohohome.com/cp/currencies-admin/edit/:id)

Use this screen when you need to check or change an existing currency.
...
![Currency Code](images/field-001-currency-code.png)
...
![currency_base_currency_code_autocomplete](images/field-002-currency-base-currency-code-autocomplete.png)
...
![currency_default_country_autocomplete](images/field-004-currency-default-country-autocomplete.png)
