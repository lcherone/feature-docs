...
- [Edit Trade Tier](../209-cp-trade-tiers-admin-edit-id-9437078d/README.md): Open an existing trade tier when you need to check the setup or make a change.
...
1. Scan the fields in the table to find the trade tier you need.
...
- Visible fields include Name, Status, Type, Currency, Min Spend Limit, and Updated.
