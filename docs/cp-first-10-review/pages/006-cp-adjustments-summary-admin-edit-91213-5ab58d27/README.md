...
![Adjustments overview](images/page-desktop.png)

*Adjustments page overview*

## Related Pages

- [Adjustments](../005-cp-adjustments-summary-admin-6754dd0f/README.md): Start here to find the adjustment you need. Search or filter the visible fields, then open a row when you need the full details.
...
![Transaction mismatch?](images/field-001-transaction-mismatch.png)
