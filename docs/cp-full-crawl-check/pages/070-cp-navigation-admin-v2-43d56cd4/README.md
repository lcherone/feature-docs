...
1. Open the Navigation (v2) page from the relevant navigation area or direct URL.
2. Use the listing to review existing Navigation (v2) entries.
...
Use the listing to search, filter, and review existing Navigation (v2) entries.
...
Select Create new to add a Navigation (v2) entry, then complete the labelled settings and save.

### Edit an existing entry

Open an existing Navigation (v2) entry to review or update its settings.
...
![Navigation Item Targeted Content](images/field-003-inline-30-navigation-item-targeted-content.png)
...
![Navigation Item UK](images/field-004-inline-30-navigation-item-uk.png)
...
![Navigation Item EU](images/field-005-inline-30-navigation-item-eu.png)
...
![Navigation Item US](images/field-006-inline-30-navigation-item-us.png)
...
![select](images/field-051-select.png)
